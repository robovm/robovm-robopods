 ...
 *  Title of the Card.
 */
@property (nonatomic, readonly, copy, ) NSString *cardTitle;
 ...
 */
+ (TWTRCardConfiguration *)appCardConfigurationWithPromoImage:(UIImage *)promoImage iPhoneAppID:( NSString *)iPhoneAppID iPadAppID:(  NSString *)iPadAppID googlePlayAppID:( NSString *)googlePlayAppID;
