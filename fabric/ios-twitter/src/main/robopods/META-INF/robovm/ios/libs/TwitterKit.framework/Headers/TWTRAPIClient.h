 ...
 */
typedef void (^TWTRLoadUserCompletion)(TWTRUser * __ user, NSError * __  error);
 ...
 *  @param error Error that will be set if the API request failed.
 */
typedef void (^TWTRLoadTweetCompletion)(TWTRTweet * __ tweet, NSError * __  error);
 ...
 *  @param error  Error that will be set if the API request failed.
 */
typedef void (^TWTRLoadTweetsCompletion)(NSArray * __ tweets, NSError * __  error);
 ...
 */
typedef void (^TWTRNetworkCompletion)(NSURLResponse * __ response, NSData * __  data, NSError * __ connectionError);
 ...
 */
typedef void (^TWTRJSONRequestCompletion)(NSURLResponse * __ response, id __  responseObject, NSError * __ error);
 ...
 */
typedef void (^TWTRTweetActionCompletion)(TWTRTweet * __ tweet, NSError * __  error);
