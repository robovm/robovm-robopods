...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/FlurryAdNativeDelegate/*</name>*/ 
    ...
    /*</properties>*/
    /*<methods>*/
    @Method(selector = "adNativeDidFetchAd:")
    void didFetchAd(FlurryAdNative nativeAd);
    @Method(selector = "adNativeWillPresent:")
    void willPresent(FlurryAdNative nativeAd);
    @Method(selector = "adNativeWillLeaveApplication:")
    void willLeaveApplication(FlurryAdNative nativeAd);
    @Method(selector = "adNativeWillDismiss:")
    void willDismiss(FlurryAdNative nativeAd);
    @Method(selector = "adNativeDidDismiss:")
    void didDismiss(FlurryAdNative nativeAd);
    @Method(selector = "adNativeDidReceiveClick:")
