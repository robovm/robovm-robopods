...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/GPGStatusDelegate/*</name>*/ 
    ...
    void didFinishGamesSignIn(NSError error);
    @Method(selector = "didFinishGamesSignOutWithError:")
    void didFinishGamesSignOut(NSError error);
    @Method(selector = "didFinishGoogleAuthWithError:")
    void didFinishGoogleAuth(NSError error);
    @Method(selector = "shouldReauthenticateWithError:")
    boolean shouldReauthenticate(NSError error);
